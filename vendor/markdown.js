...
// node_modules/@kenchan0130/markdown-to-atlassian-wiki-markup/dist/language.js
var require_language = __commonJS({
  "node_modules/@kenchan0130/markdown-to-atlassian-wiki-markup/dist/language.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    exports.AtlassianSupportLanguage = Object.assign({ None: "none" }, SupportLanguage);
...
// node_modules/@kenchan0130/markdown-to-atlassian-wiki-markup/dist/utils.js
var require_utils = __commonJS({
  "node_modules/@kenchan0130/markdown-to-atlassian-wiki-markup/dist/utils.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.uniq = exports.escapeStringRegexp = void 0;
    var escapeStringRegexp = (s) => {
...
// node_modules/@kenchan0130/markdown-to-atlassian-wiki-markup/dist/atlassianWikiMarkupRenderer.js
var require_atlassianWikiMarkupRenderer = __commonJS({
  "node_modules/@kenchan0130/markdown-to-atlassian-wiki-markup/dist/atlassianWikiMarkupRenderer.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var ListHeadCharacter = {
      Numbered: "#",
      Bullet: "*"
    };
    var TableCellTypeCharacter = {
      Header: "||",
      NonHeader: "|"
    };
    var confluenceListRegExp = new RegExp(`^(${Object.values(ListHeadCharacter).map(utils_1.escapeStringRegexp).join("|")})`);
    var unescapeHtmlSpecialCharacteres = (text) => {
    ...
    var AtlassianWikiMarkupRenderer = class extends marked_1.Renderer {
...
`;
      ...
      list(body, ordered, _start) {
        ...
        const joinedLine = lines.map((line) => {
          return line.match(confluenceListRegExp) ? `${type}${line}` : `${type} ${line}`;
        }).join("\n");
        return `
${joinedLine}
...
`;
      ...
      image(href, title, text) {
        ...
        const paramsString = Object.entries(params).filter(([, value]) => {
      ...
      tablerow(content) {
        ...
        const rowCloseType = (() => {
          ...
          if (twoPipeMatch === null || twoPipeMatch === void 0 ? void 0 : twoPipeMatch.index) {
            ...
            return indexDiff === 1 ? TableCellTypeCharacter.Header : TableCellTypeCharacter.NonHeader;
          }
...
`;
      ...
      tablecell(content, flags) {
        const type = flags.header ? TableCellTypeCharacter.Header : TableCellTypeCharacter.NonHeader;
        const emptyComplementedContent = content === "" ? " " : content;
        return `${type}${emptyComplementedContent}`;
      }
      code(code, language, _isEscaped) {
        const theme = this.rendererOptions && this.rendererOptions.codeBlock && this.rendererOptions.codeBlock.theme || exports.CodeBlockTheme.Confluence;
        const usingLang = language ? language_1.markdownToWikiMarkupLanguageMapping.get(language.toLowerCase()) || language_1.AtlassianSupportLanguage.None : language_1.AtlassianSupportLanguage.None;
        ...
        const paramsString = Object.entries(params).sort((a, b) => a[0] > b[0] ? 1 : -1).map(([key, value]) => `${key}=${value}`).join("|");
...
// node_modules/@kenchan0130/markdown-to-atlassian-wiki-markup/dist/index.js
var require_dist = __commonJS({
  "node_modules/@kenchan0130/markdown-to-atlassian-wiki-markup/dist/index.js"(exports) {
    var __importDefault = exports && exports.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.markdownToAtlassianWikiMarkup = exports.AtlassianSupportLanguage = exports.CodeBlockTheme = exports.AtlassianWikiMarkupRenderer = void 0;
    var marked_1 = __importDefault(require_marked());
    var atlassianWikiMarkupRenderer_1 = require_atlassianWikiMarkupRenderer();
    var atlassianWikiMarkupRenderer_2 = require_atlassianWikiMarkupRenderer();
    Object.defineProperty(exports, "AtlassianWikiMarkupRenderer", { enumerable: true, get: function() {
      return atlassianWikiMarkupRenderer_2.AtlassianWikiMarkupRenderer;
    } });
    Object.defineProperty(exports, "CodeBlockTheme", { enumerable: true, get: function() {
      return atlassianWikiMarkupRenderer_2.CodeBlockTheme;
    } });
    var language_1 = require_language();
    Object.defineProperty(exports, "AtlassianSupportLanguage", { enumerable: true, get: function() {
      return language_1.AtlassianSupportLanguage;
    } });
    var markdownToAtlassianWikiMarkup = (markdown, options) => {
      const renderer = new atlassianWikiMarkupRenderer_1.AtlassianWikiMarkupRenderer(options);
      return marked_1.marked(markdown, { renderer });
    };
    exports.markdownToAtlassianWikiMarkup = markdownToAtlassianWikiMarkup;
  }
});
