...
function getAttachmentAsMarkdown (attachment) {
  return `* [${attachment.name || attachment.url}](${attachment.url})`
}

function getAttachmentsAsMarkdown (card) {
...
function cardToString (
  ...
  const contentHandlers = {
    ...
    desc: (content) => {
      ...
      const shouldAppendAttachments = config['desc-append-attachments']
      ...
      const descSegments = [
        ...
        shouldAppendAttachments ? getAttachmentsAsMarkdown(card) : undefined,
